...
class EmployerController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function employerPersonalInfo()
    {
        $profile = $this->employer::where('user_id', Auth::user()->id)
        ->get()->first();
        ...
        if (file_exists(resource_path('views/extend/back-end/employer/profile-settings/personal-info/index.blade.php'))) {
            return view(
                'extend.back-end.employer.profile-settings.personal-info.index',
                  compact(
                    'nationality',
                    'birthdate',
                    'id_type',
            ...
            return view(
                'back-end.employer.profile-settings.personal-info.index',
                compact(
                  'nationality',
                  'birthdate',
                  'id_type',
    ...
    public function storePersonalInfo(Request $request)
    {
        ...
        if (!empty($request)) {
            ...
            $this->employer->storePersonalInfo($request, $user_id);
            $json['type'] = 'success';
