        ...
        <div class="wt-sliderbox">
            ...
            <div class="amt-slot-title">
                <span class="color-settings">
                    <verte v-model="gmap.sectionColor" menuPosition="left" model="hex">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40">
                            ...
                            <rect v-bind:style="{ fill: gmap.sectionColor}" y="35" width="40" height="5" rx="2.5"/>
                        </svg>
                    </verte>
                </span>
            </div>
            <div class="wt-location wt-tabsinfo">
                <div class="wt-sliderbox__form">
                    <div class="form-group form-group-half">
                        <input placeholder="Latitude" v-model="gmap.latitude" :name="'meta[gmap'+parent_index+'][latitude]'" type="text" class="form-control">
                    </div> 
                    <div class="form-group form-group-half">
                        <input placeholder="Longitude" v-model="gmap.longitude" :name="'meta[gmap'+parent_index+'][longitude]'" type="text" class="form-control">
                    </div>
                    <div class="form-group form-group">
                        <input placeholder="Title" v-model="gmap.title" :name="'meta[gmap'+parent_index+'][title]'" type="text" class="form-control">
                    </div>
                    <div class="form-group">
                      <tinymce-editor 
                          v-model="gmap.description"                         
                          :init="{
...
export default {
    ...
    created: function() {
        ...
        if (this.maps[index]) {
            ...
            this.gmap.sectionColor = this.maps[index].sectionColor
        }
        this.gmap.parentIndex = this.parent_index
    },
    mounted: function() {
        console.log('mounted')
    }
