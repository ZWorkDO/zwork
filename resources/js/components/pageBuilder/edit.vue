          ...
          <form method="POST" id="update_page" class="wt-formtheme wt-formprojectinfo wt-formcategory" @submit.prevent="updatePage()">
            <fieldset>
              ...
              <div class="form-group la-section-title" v-if="form.body && form.body !='null'">
                <tinymce-editor 
                    v-model="form.body" 
                    :init="{plugins: 'paste link code advlist autolink lists link image charmap print anchor', toolbar1: 'undo redo code | bold italic underline strikethrough | fontsizeselect formatselect | alignleft aligncenter alignright alignjustify | outdent indent |  numlist bullist checklist link anchor', menubar:false, statusbar: true, extended_valid_elements:'span[style],i[class]', resize: true, height: 400}">
                </tinymce-editor>
