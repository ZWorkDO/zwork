                    ...
                    <div class="wt-dashboardbox wt-dashboardtabsholder">
                        ...
                        <div class="wt-tabscontent tab-content">
                            ...
                            <div class="wt-personalskillshold tab-pane active fade show" id="wt-skills">
                                {!! Form::open(['url' => '', 'class' =>'wt-userform', 'id' => 'freelancer_billing_address', '@submit.prevent'=>'submitFreelancerBillingAddress']) !!}
                                    <div class="wt-yourdetails wt-tabsinfo">
                                        @if (file_exists(resource_path('views/extend/back-end/freelancer/profile-settings/billing-address/detail.blade.php'))) 
                                            @include('extend.back-end.freelancer.profile-settings.billing-address.detail')
                                        @else 
                                            @include('back-end.freelancer.profile-settings.billing-address.detail')
                                        @endif
                                    </div>
