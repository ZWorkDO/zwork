    ...
    @if ($payouts->count() > 0)
        <tbody id="payout-table">
            @foreach ($payouts as $key => $payout)
                <tr id="{{$payout->id}}">
                    <td style="border-top: 1px solid #eff2f5;color: var(--color-1);font-size: 13px;line-height: 20px;padding: 10px 20px;text-align: left;">{{ Helper::getUserName($payout->user_id) }}</td>
                    <td style="border-top: 1px solid #eff2f5;color: var(--color-1);font-size: 13px;line-height: 20px;padding: 10px 20px;text-align: left;">
                    ...
                    <td style="border-top: 1px solid #eff2f5;color: var(--color-1);font-size: 13px;line-height: 20px;padding: 10px 20px;text-align: left;">{{{ \Carbon\Carbon::parse($payout->created_at)->format('M d, Y') }}}</td>
                    {{-- <td style="border-top: 1px solid #eff2f5;color: var(--color-1);font-size: 13px;line-height: 20px;padding: 10px 20px;text-align: left;">{{{ $payout->status }}}</td> --}}
                    <td style="border-top: 1px solid #eff2f5;color: var(--color-1);font-size: 13px;line-height: 20px;padding: 10px 20px;text-align: left;">
