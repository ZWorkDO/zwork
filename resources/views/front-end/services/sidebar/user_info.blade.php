<div class="wt-widget la-empinfo-holder wt-user-service">
    <div class="wt-companysdetails">
        <figure class="wt-companysimg">
            <img src="{{{ asset(Helper::getUserProfileProfessionalBanner($seller->id, 'small')) }}}" alt="{{ trans('lang.profile_img') }}">
        </figure>
        <div class="wt-companysinfo">
            ...
            <div class="wt-userprofile">
                <div class="wt-title">
                    <h3>			
                        <a href="{{{ url('profile-professional/'.$seller->slug) }}}">
                    ...
                    <a href="{{{ url('profile-professional/'.$seller->slug) }}}" class="wt-btn">View Profile</a>
                </div>
            </div>
        </div>
    </div>
